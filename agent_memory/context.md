...
- 当前有效背景：短视频分镜工作流分为分镜、HTML、首帧图三个职责；分镜和首帧图任务已结束，当前项目进入 Git 打包与交接阶段。项目内 active skills 为 `short-video-storyboard`、`storyboard-html-delivery`、`storyboard-first-frame-images`；`.codex/skills/seedance-video/` 已于 2026-06-24 删除，后续不再作为项目依赖。
